...
namespace VMTest.Utilities
{
    ...
    internal static class MethodInvoker
    {
        ...
        private static readonly Dictionary<MethodInfo, Func<object, IEnumerable<object>, object>> MethodFunctions = new Dictionary<MethodInfo, Func<object, IEnumerable<object>, object>>();
        ...
        internal static object Invoke(MethodInfo method, object handler, params object[] parameters)
        {
            lock (_lock)
            {
                Func<object, IEnumerable<object>, object> func;
        ...
        private static Func<object, IEnumerable<object>, object> Generate(MethodInfo method)
        {
            ...
            return Expression.Lambda<Func<object, IEnumerable<object>, object>>(block, new[] { handlerVar, parametersVar }).Compile();
        }
    }
